...
- Исправление ошибок:
  Отзеркаливание теперь корректно работает с выделением.
  Стрелка теперь не меняет своего поворота при зажатом Shift.
  Квадрат можно рисовать в любых направлениях.
  Убраны лишние горячие клавиши из списка.
  Улучшена точность плавной кисти.
